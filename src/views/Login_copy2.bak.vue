              ...
              <div class="card-body">
                ...
                <form @submit.prevent="login">
                  ...
                  <div class="mb-3">
                    ...
                    <p class="font-weight-bold">เลือกโรงพยาบาล</p>
                  ...
                  <button type="submit" class="btn btn-block btn-primary image-button">
                    <img src="/images/thaid.webp" alt="ThaiD">
                    ลงชื่อใช้งานด้วย ThaID
                  </button>

                  <div class="mt-2">
                    <span class="text-secondary">ดาวน์โหลดแอปพลิเคชั่น ThaID</span> <a target="_blank"
                      href="https://www.bora.dopa.go.th/app-thaid/">ที่นี่</a>
                  </div>
  ...
  methods: {
    ...
    async toggleIframe() {
      ...
      try {
        ...
        const response = await axios.get(process.env.VUE_APP_URL_THAID + '/client/');
      ...
      try {
        ...
        const url = process.env.VUE_APP_URL_THAID + '/gen_qrcode/?' + state_encode;
    ...
    async checkActive(client_id) {
      try {
        ...
        let config = {
          method: 'post',
          url: process.env.VUE_APP_URL_THAID + `/active_by_id/?client_id=${client_id}`,
          headers: {
            'Content-Type': 'application/json'
          },
          data: data
